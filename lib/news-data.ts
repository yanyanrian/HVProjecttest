...
export const NEWS_ARTICLES: NewsArticle[] = [
  ...
  {
    slug: "carbon-defi-celo-usdglo-apr-spike",
    title: "Carbon DeFi CELO/USDGLO Pool APR Spikes Past 149%",
    summary:
    ...
    readMinutes: 5,
    tags: ["Carbon DeFi", "CELO", "USDGLO"],
    body: [
      "Liquidity providers on Carbon DeFi are seeing the highest realized yields in months. The CELO/USDGLO strategy vault reported an effective 149.06% APR over the last seven days as trading volume on the pair more than doubled.",
